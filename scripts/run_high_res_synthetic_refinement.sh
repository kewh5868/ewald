...
OUTPUT_DIR="${OUTPUT_DIR:-$HISTORY_ROOT/runs/high_res}"
LOG_DIR="${LOG_DIR:-$HISTORY_ROOT/background_logs/high_res}"
STRUCTURES_DIR="${STRUCTURES_DIR:-example/structures}"
MANIFEST="${MANIFEST:-}"
STRUCTURE_LIMIT="${STRUCTURE_LIMIT:-}"
SIMULATIONS_PER_STRUCTURE="${SIMULATIONS_PER_STRUCTURE:-3}"
DETECTOR_SHAPE="${DETECTOR_SHAPE:-384x576}"
HKL_EXTENT="${HKL_EXTENT:-7}"
PEAK_MAX_PEAKS="${PEAK_MAX_PEAKS:-360}"
CANDIDATE_MAX="${CANDIDATE_MAX:-18}"
MAX_GENERATED_CIFS="${MAX_GENERATED_CIFS:-12}"
MAX_SCAFFOLDS="${MAX_SCAFFOLDS:-18}"
MAX_ORGANIC_PROXIES="${MAX_ORGANIC_PROXIES:-12}"
MAX_ORGANIC_REPLACEMENTS="${MAX_ORGANIC_REPLACEMENTS:-8}"
STAGE_SIMULATION_MAX_CIFS="${STAGE_SIMULATION_MAX_CIFS:-6}"
ORGANIC_RMC_STEPS="${ORGANIC_RMC_STEPS:-16}"
...
BRAGG_INTENSITY_WEIGHT="${BRAGG_INTENSITY_WEIGHT:-0.35}"
BRAGG_INTENSITY_TOLERANCE="${BRAGG_INTENSITY_TOLERANCE:-0.08}"
BRAGG_INTENSITY_MAX_PEAKS="${BRAGG_INTENSITY_MAX_PEAKS:-80}"
...
LOG_FILE="$LOG_DIR/synthetic_high_res_${STAMP}.log"
PID_FILE="$LOG_DIR/synthetic_high_res_${STAMP}.pid"
...
echo "Started high-resolution synthetic refinement in the background."
echo "PID: $pid"
echo "Log: $LOG_FILE"
