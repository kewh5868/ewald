...
class MainWindow(QMainWindow):
    ...
    def _compute_and_overlay_peaks(self):
        """
        Compute Bragg peaks (q_{xy}, q_{z}, hkl) and update image and table,
        ...
        qz_filt  = qz[mask]
        hkl_filt = hkl[mask]
        print(f"[DEBUG] {qxy_filt.size} peaks after filtering positive q_{{xy}}/q_{{z}}")
        ...
        # Populate Calculated table with filtered (q_{xy}, q_{z}, h, k, l)
        peaks = [
