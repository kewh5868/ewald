...
# UI components
from ..ui.left_pane.file_tree import FileTreeView
from ..ui.center_pane.image_view import ImageCanvas
from ..ui.bottom_pane.peak_table import PeakTableView
from ..ui.right_pane.unit_cell_view import UnitCellView
from ..ui.right_pane.structure_tree import StructureTreeView
from ..ui.right_pane.cell_params import CellParamsEditor
from ..ui.top_window.appmenubar import AppMenuBar
from ..ui.top_window.maintoolbar import MainToolBar
from ..ui.center_pane.roi_manager import ROIManager
from ..ui.dialogs.load_single_image_dialog import LoadSingleImageDialog
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        # self.toolbar.load_single_action.triggered.connect(self.open_load_single_image_dialog)
    ...
    def _show_load_single_dialog(self):
        dlg = LoadSingleImageDialog(self)
        # connect once per dialog instance
    ...
    def _on_new_single_image(self, single_image):
        ...
        self.fileTree.add_data_object(single_image)

        # optionally expand and select the newly added item
        index = self.fileTree.model.indexFromItem(self.fileTree._items[name])
